  ...
  if (!room) {
    return (
      <ScrollView style={{ flex:1, backgroundColor: th.bg }} contentContainerStyle={{ padding:24, alignItems:'center' }}>
        ...
        <Touchable onPress={createRoom} disabled={loading}
        ...
        <Touchable onPress={joinRoom} disabled={loading}
    ...
    <ScrollView style={{ flex:1, backgroundColor: th.bg }} contentContainerStyle={{ padding:16, paddingBottom:40 }}>
      <View style={[s.card, { backgroundColor: th.card, borderColor: th.border }]}>
        <View style={{ flexDirection:'row', justifyContent:'space-between', alignItems:'center' }}>
          ...
          <Touchable onPress={copyCode} style={[s.codeChip, { backgroundColor: th.primSoft, flexDirection:'row', alignItems:'center', gap:6 }]}>
      ...
      <Touchable onPress={() => Alert.alert(L.leaveRoom, '', [
