  ...
  return (
    <>
      ...
      <MenuGroup th={th}>
        ...
        <MenuRow th={th} isAr={isAr} icon="information-circle-outline" title={isAr ? 'لقطات الشاشة معطّلة' : 'Screenshots are disabled'} subtitle={isAr ? 'لحماية أرصدتك من الظهور في شاشة التطبيقات الأخيرة. لمشاركة تقرير أو حفظه، استخدم التصدير إلى PDF من شاشة التقارير.' : 'To keep your balances out of the recent-apps preview. To share or save a report, use PDF export from Reports.'} />
