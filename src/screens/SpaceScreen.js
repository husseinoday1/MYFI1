...
export default function SpaceScreen() {
  ...
  if (!room) {
    return (
      <ScrollView style={{ flex:1, backgroundColor: th.bg }} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" nestedScrollEnabled contentContainerStyle={{ padding:24, alignItems:'center' }}>
        ...
        <TextInput value={codeInput} onChangeText={setCodeInput}
          placeholder={L.roomCodeHint} placeholderTextColor={th.sub}
  ...
  return (
    <ScrollView style={{ flex:1, backgroundColor: th.bg }} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" nestedScrollEnabled contentContainerStyle={{ padding:16, paddingBottom:40 }}>
