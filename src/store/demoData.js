...
export const buildDemoWorkspace = (currentCfg = {}) => {
  ...
  // Demo-only recurring examples intentionally have no current-month copy,
  // so Home can show both a due recurring expense and a due recurring income.
  addTx({
    id: 'demo_recurring_streaming_prev',
    title: 'اشتراك منصة فيديو',
    amt: -22000,
    cat: 'entertain',
    dateISO: demoDate(-1, 11),
    walletId: 'demo_bank',
    flowType: FLOW_TYPES.EXPENSE,
    recurring: true,
    recurringGroupId: 'demo_recurring_streaming',
    transactionTag: 'subscription',
  });
  addTx({
    id: 'demo_recurring_side_income_prev',
    title: 'دخل جانبي متكرر',
    amt: 180000,
    cat: 'salary',
    dateISO: demoDate(-1, 13),
    walletId: 'demo_cash',
    flowType: FLOW_TYPES.INCOME,
    recurring: true,
    recurringGroupId: 'demo_recurring_side_income',
  });
  ...
  return {
    ...
    debts: [{
      ...
      id: 'demo_linked_debt',
      name: 'قرض لابتوب — مرتبط بالتزام',
      total: 2400000,
      paid: 0,
      archivedPaid: 0,
      direction: 'owed',
      scope: 'personal',
      createdAt: demoDate(-3, 6),
      payments: [],
    }],
    goals: [{
      id: 'demo_goal',
      ...
      id: 'demo_linked_goal',
      name: 'دفعة السيارة — بدون توفير هذا الشهر',
      target: 6000000,
      cur: 0,
      archivedSaved: 0,
      scope: 'personal',
      createdAt: demoDate(-2, 4),
      savings: [],
    }],
    commitments: [{
      id: 'demo_commitment',
      ...
      id: 'demo_commitment_unpaid',
      name: 'فاتورة الكهرباء — غير مدفوعة',
      amt: 95000,
      day: 9,
      firstDueISO: demoDate(-4, 9),
      cat: 'other',
      walletId: 'demo_cash',
      linkedType: 'none',
      linkedId: null,
      ...
      active: true,
      scope: 'personal',
      lastPaidMonth: monthKey(demoDate(-1, 9)),
    }, {
      id: 'demo_linked_debt_commitment',
      name: 'قسط اللابتوب — دين محوّل لالتزام',
      amt: 200000,
      day: 14,
      firstDueISO: demoDate(-2, 14),
      cat: 'other',
      walletId: 'demo_bank',
      linkedType: 'debt',
      linkedId: 'demo_linked_debt',
      repeatMonthly: true,
      active: true,
      scope: 'personal',
      lastPaidMonth: monthKey(demoDate(-1, 14)),
    }, {
      id: 'demo_linked_goal_commitment',
      name: 'دفعة السيارة — هدف مرتبط',
      amt: 300000,
      day: 17,
      firstDueISO: demoDate(-2, 17),
      cat: 'other',
      walletId: 'demo_savings',
      linkedType: 'goal',
      linkedId: 'demo_linked_goal',
      repeatMonthly: true,
      active: true,
      scope: 'personal',
      lastPaidMonth: monthKey(demoDate(-1, 17)),
    }, {
      id: 'demo_commitment_deferred',
      name: 'صيانة السيارة — مؤجل',
      amt: 125000,
      day: 7,
      firstDueISO: demoDate(-3, 7),
      cat: 'transport',
      walletId: 'demo_cash',
      linkedType: 'none',
      linkedId: null,
      ...
      active: true,
      scope: 'personal',
      lastPaidMonth: monthKey(demoDate(-1, 7)),
      deferredUntilISO: demoDate(0, 24),
      deferredCycleMonth: monthKey(demoDate(0, 7)),
    }],
    wallets,
    cats: DEF_CATS,
    cfg,
