...
export function Touchable(props) {
  return <PressableScale scale={props.scale ?? 0.985} haptic={props.haptic ?? 'selection'} {...props} />;
}
...
const s = StyleSheet.create({
  ...
  sectionTitle: { flex: 1, fontSize: TYPE.section, lineHeight: 18, fontWeight: '900', letterSpacing: 0.4 },
  button: {
    minHeight: 44,
