# MaalFlow — CANONICAL DOCUMENT AUTHORITY
## Effective: 2026-08-16
## Status: BINDING FOR FUTURE MaalFlow WORK

This document exists to eliminate duplicate/contradictory MaalFlow planning files.

# 1. Mandatory authority rule

For future MaalFlow work, **do not choose a document because its filename says
...
`01_CORE_AUTHORITY/MAALFLOW_MASTER_PLAN_FROZEN.md`
...
`MAALFLOW_MASTER_PLAN_FROZEN_WITH_USER_AUDIT_ADDENDUM_REV2_2026-08-15.md`.
...
`01_CORE_AUTHORITY/MAALFLOW_R04_1_ACCEPTANCE_RECOVERY_ADDENDUM.md`
and
...
- `01_CORE_AUTHORITY/MAALFLOW_USER_NOTES_RECONCILIATION_CANONICAL_2026-08-16.md`
- `04_CURRENT_EVIDENCE/MYFI_CURRENT_ACCEPTANCE_DELTA_2026-08-16.md`
...
- `MAALFLOW_MASTER_PLAN_FROZEN_WITH_USER_AUDIT_ADDENDUM_REV2_2026-08-15.md`
  - superseded by the newly supplied `MAALFLOW_MASTER_PLAN_FROZEN.md` + active addenda.
...
Before editing MaalFlow, the assistant/Codex must state:
...
- `docs/01_CORE_AUTHORITY/MAALFLOW_MULTI_CURRENCY_FINANCIAL_POLICY_ADDENDUM.md` — canonical policy for multi-currency financial calculation, historical FX, current valuation, transfers, budgets, debts/goals, Base Currency, and future Display Currency.
...
Added by the MaalFlow Planning & Audit process after a 2026-08-19 incident: a
...
- `docs/01_CORE_AUTHORITY/MAALFLOW_P19_SYNC_V2_ACTIVATION_ADDENDUM.md`, now including the P19-012 empty-shell recovery and P19-013 atomic V2 remote-apply rules.
