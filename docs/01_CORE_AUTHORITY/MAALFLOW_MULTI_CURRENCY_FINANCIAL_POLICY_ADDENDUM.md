# MaalFlow Multi-Currency Financial Policy & Reporting Engine Addendum

**Status:** ACTIVE — approved 2026-08-17  
**Authority type:** Canonical financial-policy addendum  
**Amends:** Multi-currency interpretation of the frozen MaalFlow master plan without rewriting the frozen plan  
**Implementation impact of this documentation package:** NONE

## 1. Core Policy

MaalFlow MUST preserve the original currency truth of every financial event while using one Base/Home Currency for aggregated reporting.
...
9. **Central currency-rate registry is the future current-rate source.** Saving a transaction freezes the reviewed historical snapshot. MaalFlow MUST NOT invent a missing historical FX rate.
