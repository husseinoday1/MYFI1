# MaalFlow — Canonical Design System

**Registered:** 2026-08-25 · **Updated:** 2026-08-26 (Product Owner rulings
applied) · **Status:** CANONICAL
**Basis:** `02_MAALFLOW_VISUAL_IDENTITY_CANONICAL.md`, `04_MAALFLOW_DESIGN_TOKEN_CATALOG.md`,
`14_MAALFLOW_APPROVED_VISUAL_REFERENCE_REGISTER.md`, and direct code evidence at HEAD
...
in `04_MAALFLOW_DESIGN_TOKEN_CATALOG.md` and referenced, not duplicated, here.
...
see `06_MAALFLOW_NAVIGATION_AND_INFORMATION_ARCHITECTURE.md` for primary
...
Governed by `02_MAALFLOW_VISUAL_IDENTITY_CANONICAL.md` §10-11-6 — this document
