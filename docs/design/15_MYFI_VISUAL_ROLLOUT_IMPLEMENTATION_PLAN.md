...
### المرحلة 3 — المتابعات ومساراتها (مرحلة مستقلة، موصى بها لكلاود)
...
### المرحلة 4 — التقارير وبصيرة MYFI (مرحلة مستقلة)
...
### المرحلة 5 — المزيد والإعدادات وخطة توزيع الدخل (مرحلة مستقلة)
...
## 5. تنسيق العمل المتوازي: Codex + Claude

1. Codex يمتلك **المرحلة 1 فقط** الآن (الرئيسية).
2. Claude يختار **مرحلة واحدة فقط** غير المرحلة 1 من المراحل 2–5، ويفضل المرحلة 3 لأنها محددة وتعزل الملفات جيدًا.
3. قبل أي تعديل، يكتب Claude في رسالته المرحلة والملفات التي سيملكها؛ لا يلمس ملفات مرحلة Codex أو ملفات مرحلة أخرى.
4. لا أحد يحذف منطقًا ماليًا، يغير مخطط البيانات، يكتب بيانات تجريبية فوق بيانات المستخدم، أو يدفع إلى GitHub.
5. عند ظهور اعتماد بين مرحلتين (مثل خطة توزيع الدخل ↔ التقارير)، يبنى عقد بيانات صغير ومختبر أو يترك المدخل مخفيًا إلى أن يكون المسار واقعيًا؛ لا زر ميت.
6. كل مرحلة تسلم: تغييرات محلية، قائمة ملفات، اختبارات منفذة، لقطات داكن/فاتح عند الاقتضاء، وما تبقى خارج نطاقها.
