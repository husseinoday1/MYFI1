...
`08_MAALFLOW_DESIGN_GOVERNANCE.md` §10. This is the single place to check
...
**Documents updated:** `docs/00_MAALFLOW_CANONICAL_AUTHORITY.md`.
...
**Evidence:** `14_MAALFLOW_APPROVED_VISUAL_REFERENCE_REGISTER.md`.
**Financial/data impact:** NONE.
...
**Documents updated:** `02_MAALFLOW_VISUAL_IDENTITY_CANONICAL.md` §5,
`04_MAALFLOW_DESIGN_TOKEN_CATALOG.md`.
**Financial/data impact:** NONE.
...
CURRENT TARGET / REMOVE FROM TARGET. Not approved MaalFlow capabilities; not to
...
**not** canonically purple. It belongs to the MaalFlow olive/green brand system
...
canonical (`10_MAALFLOW_CHART_AND_FINANCIAL_VISUALIZATION_SYSTEM.md`). Net worth
