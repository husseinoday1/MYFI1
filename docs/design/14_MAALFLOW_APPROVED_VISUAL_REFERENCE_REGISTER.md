# MaalFlow — Approved Visual Reference Register
...
**Source:** images pasted directly into the MaalFlow Planning & Audit conversation,
described by the user as "the latest Product Owner-approved MaalFlow visual
references."
...
the user-supplied 2×2 question reference, but uses MaalFlow brand green rather than
...
- **Approved design principles:**
  - Centered "MaalFlow" wordmark in the brand green, profile icon left, bell
...
- **Canonical documents influenced:** `02_MAALFLOW_VISUAL_IDENTITY_CANONICAL.md`,
  `07_MAALFLOW_SCREEN_DESIGN_SPECIFICATIONS.md` (Home row), `archive/MYFI_BLUEPRINT_REVISION_MAP.md`.
...
- **Known textual corrections:** **product-positioning note (2026-08-26):**
  ...
  requirement, but MaalFlow's product positioning must remain internationally
  ...
  rewrite.
- **Canonical documents influenced:** `02_MAALFLOW_VISUAL_IDENTITY_CANONICAL.md`
  (onboarding tone), `01_MAALFLOW_MASTER_PRODUCT_DESIGN_BLUEPRINT.md`.
...
- **Approved design principles:** success state (checkmark + sparkle
  ...
  single primary CTA ("ابدأ استخدام MaalFlow").
- **Known textual corrections:** none identified.
...
- **Global Design System principles derived:** the View/Add/Complex-flow
  navigation-pattern legend (→ `03_MAALFLOW_DESIGN_SYSTEM_CANONICAL.md` §Navigation).
- **Canonical documents influenced:** `03_MAALFLOW_DESIGN_SYSTEM_CANONICAL.md`,
  `07_MAALFLOW_SCREEN_DESIGN_SPECIFICATIONS.md` (My Money + 4 sub-screens),
...
- **Approved design principles:**
  ...
  - A floating "+" plus an explicit on-canvas note that the Quick-Add row
    ...
    reference showed it — the global Side `+` button belongs to the MaalFlow
...
- **Known textual corrections:** none identified.
- **Canonical documents influenced:** `07_MAALFLOW_SCREEN_DESIGN_SPECIFICATIONS.md`
  (Follow-ups + 6 sub-sections), `05_MAALFLOW_COMPONENT_ARCHITECTURE.md`
...
- **Known textual corrections:** none identified. Note: the
  ...
  Settings root.
- **Canonical documents influenced:** `07_MAALFLOW_SCREEN_DESIGN_SPECIFICATIONS.md`
  (More + 5 sub-sections, Archive relocation), `05_MAALFLOW_COMPONENT_ARCHITECTURE.md`.
...
- **Approved design principles:**
  ...
  - Root list is **exactly five rows**, matching the Blueprint's approved
    ...
    MaalFlow account-type model; the approved onboarding removed Personal/
...
- **Canonical documents influenced:** `07_MAALFLOW_SCREEN_DESIGN_SPECIFICATIONS.md`
  (Settings root + 5 sections), `04_MAALFLOW_DESIGN_TOKEN_CATALOG.md` (explicitly
