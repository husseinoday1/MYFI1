# MaalFlow — Design Migration Roadmap
...
phase, following standing MaalFlow engineering rules (CI-only acceptance
...
`04_MAALFLOW_DESIGN_TOKEN_CATALOG.md`). No screen changes yet.
...
`10_MAALFLOW_CHART_AND_FINANCIAL_VISUALIZATION_SYSTEM.md`); evaluate against the
