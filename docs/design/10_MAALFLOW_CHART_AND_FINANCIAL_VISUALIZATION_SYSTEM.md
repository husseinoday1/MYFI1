# MaalFlow — Chart and Financial Visualization System
...
preview (`14_MAALFLOW_APPROVED_VISUAL_REFERENCE_REGISTER.md`, REF-04), and the
...
- Category-share charts use `category.palette` (see
  `04_MAALFLOW_DESIGN_TOKEN_CATALOG.md`, the audited/muted 12-hue set).
...
`09_MAALFLOW_ACCESSIBILITY_RTL_AND_RESPONSIVE.md`.
...
Follow the app-wide states defined in `11_MAALFLOW_SYSTEM_STATES_AND_FEEDBACK.md`
...
rules: `09_MAALFLOW_ACCESSIBILITY_RTL_AND_RESPONSIVE.md`.
