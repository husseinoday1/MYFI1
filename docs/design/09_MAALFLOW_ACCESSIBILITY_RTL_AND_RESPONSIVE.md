# MaalFlow — Accessibility, RTL, and Responsive
...
- **Income is UP, Expense is DOWN** (corrected 2026-08-26 — a prior
  ...
  `14_MAALFLOW_APPROVED_VISUAL_REFERENCE_REGISTER.md`, REF-01).
...
- **Reduced motion:** no motion system exists yet to evaluate (see
  `03_MAALFLOW_DESIGN_SYSTEM_CANONICAL.md` §15); reduced-motion support is a
...
Expo/device feedback loop (`01_MAALFLOW_MASTER_PRODUCT_DESIGN_BLUEPRINT.md` §18)
exists to close out.
