...
البريد يعرّف المستخدم ويسمح بالدعوات والمزامنة. امتلاك حساب بريد لا يمنح صلاحية على بيانات مستخدم آخر.
...
2. يدعو مستخدماً آخر عبر البريد.
...
البريد يستخدم للهوية والدعوة فقط، وليس للوصول إلى الحساب الشخصي خارج الغرفة.
