...
assert(!onboarding.includes('languageConfirmed') && !onboarding.includes("langMode: 'manual'"), 'The welcome language selection must stay local to onboarding reading direction only and must not persist as a whole-app preference');
