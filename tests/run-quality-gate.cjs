...
const staticContracts = [
  ...
  'performance-v7-cutover-contract.test.cjs',
  ...
  'p20-v2-conflict-status.test.cjs',
  'p20-local-reset-v2-interlock.test.cjs',
  'p20-phase12a-archive-channel.test.cjs',
  'p20-phase12c-bootstrap-recovery-session.test.cjs',
  'p20-phase12c-bootstrap-recovery-stage.test.cjs',
  'p20-phase12d-bootstrap-recovery-promotion.test.cjs',
  'p20-phase12d-archive-recovery-stage.test.cjs',
  'p20-phase12d-recovery-coordinator.test.cjs',
...
const runtimeTests = [
  ...
  ['SQLITE_RUNTIME', 'goal_release_undo_ledger', 'run-goal-release-undo-ledger.cjs'],
  ...
  ['SQLITE_RUNTIME', 'p20_v2_conflict_intent_retire', 'run-p20-v2-conflict-intent-retire.cjs'],
  ['SQLITE_RUNTIME', 'p20_v2_stale_command_repair', 'run-p20-v2-stale-command-repair.cjs'],
  ['UNIT_RUNTIME', 'p20_v2_recovery_gates', 'run-p20-v2-recovery-gates.cjs'],
  ['UNIT_RUNTIME', 'p13_legacy_mirror_gate', 'run-p13-legacy-mirror-gate.cjs'],
  ['UNIT_RUNTIME', 'p14_maintenance_resume_signal', 'run-financial-maintenance-resume-signal.cjs'],
  ['UNIT_RUNTIME', 'p14_maintenance_resume_wiring', 'run-financial-maintenance-resume-wiring.cjs'],
  ['UNIT_RUNTIME', 'p14_outbox_retry_policy', 'run-p14-outbox-retry-policy.cjs'],
  ...
  ['SQLITE_RUNTIME', 'p20_phase12d_bootstrap_recovery_promotion', 'run-p20-phase12d-bootstrap-recovery-promotion.cjs'],
  ['UNIT_RUNTIME', 'p20_phase12d_archive_recovery_stage', 'run-p20-phase12d-archive-recovery-stage.cjs'],
  ['UNIT_RUNTIME', 'p20_phase12d_recovery_coordinator', 'run-p20-phase12d-recovery-coordinator.cjs'],
  ...
  ['UNIT_RUNTIME', 'planning_periods', 'run-planning-periods.cjs'],
  ['UNIT_RUNTIME', 'monthly_plan', 'run-monthly-plan.cjs'],
