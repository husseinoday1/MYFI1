...
assert(onboarding.includes("langMode: 'manual'") && /finish = async[\s\S]*?langMode: 'manual'/.test(onboarding), 'Finishing onboarding must commit the selected welcome language as the real app language');
