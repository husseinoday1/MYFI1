// P11-A — runs the §73/§76 archive balance-invariance test under the same
// babel/commonjs shim the other V7 runtime tests use.
...
const filename = path.join(__dirname, 'p11a-archive-balance-invariance.test.mjs');
