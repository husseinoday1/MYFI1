...
must(constants.includes("DEMO_ACTIVE: 'MAALFLOW_DEMO_ACTIVE_V1'"), 'persistent demo-active storage key is missing');
must(dataSlice.includes('MAALFLOW_PERFORMANCE_DATA_PERSISTENCE_V5_1_1'), 'dataSlice hotfix marker missing');
must(storage.includes('MAALFLOW_PERFORMANCE_DATA_RUNTIME_V5_1_2'), 'performance storage boundary marker missing');
...
console.log('MaalFlow PERFORMANCE DATA PERSISTENCE V5.1.1: PASSED');
