...
assert.match(repository, /migrationId: '0012_archive_recovery_stage_rows',[\s\S]*?toVersion:\s*12/);
assert.match(repository, /migrationId: '0013_posting_transaction_index',[\s\S]*?toVersion:\s*FINANCIAL_SQLITE_SCHEMA_VERSION/);
