...
tool is currently acting as MaalFlow's primary engineer quickly, without
...
If anything in this file conflicts with the repository, `docs/00_MAALFLOW_CANONICAL_AUTHORITY.md`,
...
MaalFlow is a local-first personal-finance Android/Expo app, in Arabic, RTL-first.
...
Defined canonically in [`docs/00_MAALFLOW_CANONICAL_AUTHORITY.md`](docs/00_MAALFLOW_CANONICAL_AUTHORITY.md).
...
2. **A1 — Frozen Master Plan.** `docs/01_CORE_AUTHORITY/MAALFLOW_MASTER_PLAN_FROZEN.md`
...
`00_MAALFLOW_CANONICAL_AUTHORITY.md` §3 (old REV2 master plan, old reconciliation
...
`MAALFLOW_PRODUCT_BLUEPRINT.md` at the repo root is an **early, superseded
...
Team structure as of 2026-08-21 (see docs/00_MAALFLOW_CANONICAL_AUTHORITY.md
...
From `docs/MAALFLOW_FINANCIAL_CONTRACT.md` and the multi-currency policy addendum:
...
Also binding: `docs/MAALFLOW_DATA_OWNERSHIP.md`, `docs/MAALFLOW_SYNC_PROTOCOL.md`,
`docs/MAALFLOW_BACKUP_FORMAT.md`, `docs/MAALFLOW_DATE_TIME_CONTRACT.md`,
`docs/MAALFLOW_MIGRATION_POLICY.md`, `docs/MAALFLOW_PERFORMANCE_SLO.md`,
`docs/MAALFLOW_RELEASE_SCOPE.md`, `docs/MAALFLOW_SECURITY_THREAT_MODEL.md`. Read the
...
Full contract: `docs/MAALFLOW_SYNC_PROTOCOL.md`,
...
without Phase 7 complete) — see `MAALFLOW_MASTER_PLAN_FROZEN.md` §167 ("Definition
...
`docs/00_MAALFLOW_CANONICAL_AUTHORITY.md` § "Standing Engineering Rules"),
...
conversation, not registered in `00_MAALFLOW_CANONICAL_AUTHORITY.md` or the
...
2. Read `docs/00_MAALFLOW_CANONICAL_AUTHORITY.md`, then the Frozen Master Plan
